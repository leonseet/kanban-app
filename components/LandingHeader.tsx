        ...
        <DropdownMenu open={isMenuOpen} onOpenChange={() => setIsMenuOpen(!isMenuOpen)}>
          <DropdownMenuTrigger asChild>
            <div className="flex gap-4 items-center">
              {!isMenuOpen && <LogoMobile className="w-6 h-6" />}
              {isMenuOpen && <ChevronDown className="w-6 h-6" />}
              <h1 className="font-heading text-lg">Menu</h1>
            </div>
          </DropdownMenuTrigger>
          <DropdownMenuContent className="w-screen p-4 mt-4">
